...
%for concentric = 1:concentric_tot
    ...
    surf(concentric_vector,noise_vals,magnitude_percentage_error)
    xlabel('No. Concentric Burgers Circuits')
    ylabel('Noise Coefficient (strain)')
    zlabel('Error in Magnitude (%)')
    ...
    surf(concentric_vector,noise_vals,angular_separation)
    xlabel('No. Concentric Burgers Circuits')
    ylabel('Noise Coefficient (strain)')
    zlabel(['Angular Separation (' char(176) ')'])
    %set(gca,'YScale', 'log','ZScale','log');
    set(gca, 'YScale', 'log');
    colorbar
%end

sgtitle('Test 3B - Variation of Computed Burgers Vector with Noise and No. Concentric Burgers Circuits')